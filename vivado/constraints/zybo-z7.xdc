...
# For additional inputs, could use buttons or ChipKit pins if needed
...
# --------------------------------------------------------------------------------------------------
# JTAG Headers (Using ChipKit Inner Digital Header)
# --------------------------------------------------------------------------------------------------
set_property -dict { PACKAGE_PIN V8   IOSTANDARD LVCMOS33 }     [get_ports { jtag_tms_i   }];    #IO_L15P_T2_DQS_13 Sch=CK_IO32
set_property -dict { PACKAGE_PIN W8   IOSTANDARD LVCMOS33 }     [get_ports { jtag_tdi_i   }];    #IO_L15N_T2_DQS_13 Sch=CK_IO38
set_property -dict { PACKAGE_PIN U7   IOSTANDARD LVCMOS33 }     [get_ports { jtag_tdo_o   }];    #IO_L11P_T1_SRCC_13 Sch=CK_IO29
set_property -dict { PACKAGE_PIN V7   IOSTANDARD LVCMOS33 }     [get_ports { jtag_tck_i   }];    #IO_L11N_T1_SRCC_13 Sch=CK_IO30

# --------------------------------------------------------------------------------------------------
# UART Headers (Using ChipKit Outer Digital Header)
# --------------------------------------------------------------------------------------------------
set_property -dict { PACKAGE_PIN V15  IOSTANDARD LVCMOS33 }     [get_ports { uart_rx_i }];       #IO_L10P_T1_34 Sch=CK_IO4
